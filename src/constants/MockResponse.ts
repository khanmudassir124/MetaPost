...
const MockResponse = {
  hits: [
    ...
    {
      created_at: '2023-07-06T06:20:02.000Z',
      title: 'Secam and Comparison to NTSC and Pal [video]',
      url: 'https://www.youtube.com/watch?v=KtWcKkEOP64',
      author: 'redbell',
      points: 1,
      story_text: null,
      comment_text: null,
      ...
      story_url: null,
      parent_id: null,
      created_at_i: 1688624402,
      _tags: ['story', 'author_redbell', 'story_36612026'],
      objectID: '36612026',
      _highlightResult: {
        title: {
          value: 'Secam and Comparison to NTSC and Pal [video]',
          matchLevel: MatchLevel.None,
          matchedWords: [],
        },
        url: {
          value: 'https://www.youtube.com/watch?v=KtWcKkEOP64',
          matchLevel: MatchLevel.None,
          matchedWords: [],
        },
        author: {
